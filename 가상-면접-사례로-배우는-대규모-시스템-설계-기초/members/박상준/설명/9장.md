...
>
> 이 있는데, 실제로 가장 많이 쓰이는 방식은 **JA3 핑거프린트** 방식이다.
>
> JA3 는
>
> ```
...
> **HTTP 헤더 분석?**
>
> - 헤더에 Referer 가 있는지, Accept-Language 등이 있는지 각각 원래 크롬이나 사파리라면 있어야하는 헤더의 값이나 순서가 안맞는다던가의 헤더 구조 분석을 하는거임
...
- 처음 solving 과정에서 리소스를 많이 쓰고 동시 처리 제한에 한계가 있어서.. 대안이 될까 싶다.

### 4. ScrapingBee

- 웹 스크래핑을 위한 유료 클라우드 API
  - 복잡한 차단 우회를 직접 구현 X
